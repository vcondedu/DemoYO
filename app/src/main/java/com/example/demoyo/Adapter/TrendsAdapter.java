package com.example.demoyo.Adapter;
...
public class TrendsAdapter extends RecyclerView.Adapter<TrendsAdapter.ViewHolder> {
    ArrayList<ClsTrendsDomain> items;
    Context context;

    public TrendsAdapter(ArrayList<ClsTrendsDomain> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(@NonNull TrendsAdapter.ViewHolder holder, int position) {
        ...
        int drawableResourceId = holder.itemView.getResources().getIdentifier(items.get(position).getPicAddress(),
